...
static void aio_progress_notification(union sigval sig)
{
    ...
    syslog(LOG_INFO,
         "into function aio_progress_notification\n");
    closelog();
#endif
...
static void start_delayed_ops_if_any(int dec_first)
{
    ...
    openlog("MyLog", LOG_CONS | LOG_PID, LOG_LOCAL2);
    syslog(LOG_INFO,
         "into function start_delayed_ops_if_any");
    closelog();
#endif
    ...
    int aiocb_inuse_count, struct sigevent *sig, int dec_first)
{
    ...
    openlog("MyLog", LOG_CONS | LOG_PID, LOG_LOCAL2);
    syslog(LOG_INFO,
       "into function issue_or_delay_io_operation");
    closelog();
#endif
                       ...
                       PVFS_hint  hints)
{
    ...
    openlog("MyLog", LOG_CONS | LOG_PID, LOG_LOCAL2);
    syslog(LOG_INFO,
       "into function dbpf_bstream_flush");
    closelog();
#endif
...
static int dbpf_bstream_flush_op_svc(struct dbpf_op *op_p)
{
      ...
      openlog("MyLog", LOG_CONS | LOG_PID, LOG_LOCAL2);
      syslog(LOG_INFO,
         "into function dbpf_bstream_flush_op_svc");
      closelog();
  #endif
                                ...
                                PVFS_hint  hints)
{
      ...
      openlog("MyLog", LOG_CONS | LOG_PID, LOG_LOCAL2);
      syslog(LOG_INFO,
         "into function dbpf_bstream_rw_list");
      closelog();
  #endif
    ...
    TROVE_context_id context_id)
{
      ...
      openlog("MyLog", LOG_CONS | LOG_PID, LOG_LOCAL2);
      syslog(LOG_INFO,
         "into function dbpf_bstream_cancel");
      closelog();
  #endif
